...
export dataSetActual=/GJets_HT-40To100_8TeV-madgraph/Summer12_DR53X-PU_S10_START53_V19-v1/AODSIM
export CMS2NtupleLocation=/hadoop/cms/store/group/snt/papers2012/Summer12_53X_MC/GJets_HT-40To100_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V19-v1/V05-03-31/
export dataSet=`echo ${dataSetActual#/} | sed 's/\/AODSIM//g' | sed 's/\//_/g'`
export dataset=photon_mght40
export isdata=false
