...
if len(sys.argv) < 5 :
    ...
    print '\t-runViaCondor\t\tUse a subset of the sequence that is compatible with submission to condor. Default is to not use it.'
    sys.exit()
...
if runViaCondor == True :
    print 'Creating cfg for condor submission.'
